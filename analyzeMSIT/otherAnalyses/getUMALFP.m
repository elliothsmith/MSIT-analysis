...
for fl = 1:3
    switch fl
        case 1
            dataFile = './Experiment_II__dlPFC/CUCX2/Data/******02-111303-001.ns5';
        case 2
            dataFile = './Experiment_II__dlPFC/CUCX2/Data/******03-115008-001.ns5';
        case 3
            dataFile = './Experiment_II__dlPFC/CUCX2/Data/******07-140905-008.ns5';            
    end
    fprintf('\nfile: %d',fl)
